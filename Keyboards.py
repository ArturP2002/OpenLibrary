...
# Клавиатура главного меню(основная функция возвращения в меню)
...
button_story_commands = telebot.types.KeyboardButton(text='История команд \U0001F6E0')
...
main_menu_kb.add(button_story_commands)
...
# Inline-клавиатура для перехода к выбору количества книг
